...
fig.add_trace(go.Scatter(x=[mean, mean], y=[
              0, 0.16], mode='lines', name="Mean"))
fig.add_trace(go.Scatter(x=[first_std_d_start, first_std_d_start], y=[
              0, 0.16], mode='lines', name="Standard Deviation 1"))
fig.add_trace(go.Scatter(x=[first_std_d_end, first_std_d_end], y=[
              0, 0.16], mode='lines', name="Standard Deviation 1"))
fig.add_trace(go.Scatter(x=[second_std_d_start, second_std_d_start], y=[
              0, 0.16], mode='lines', name="Standard Deviation 2"))
fig.add_trace(go.Scatter(x=[second_std_d_end, second_std_d_end], y=[
              0, 0.16], mode='lines', name="Standard Deviation 2"))
fig.show()
